		...
		<view class="bg-custom-container">
			...
			<view class="charts-item">
				...
				<view class="cu-bar bg-white margin-top-xs">
					<view class="gauge action sub-title">
						<text class="text-xl text-bold text-blue text-shadow">网速测试</text>
						<text class="text-ABC text-blue" style="white-space: nowrap;">网速测试</text>
					</view>
				</view>
				<view class="guage-charts-box">
			...
			<view class="charts-item">
				<!-- 折线图 -->
				<view class="cu-bar bg-white margin-top-xs">
					<view class="gauge action sub-title"><text class="text-xl text-bold text-blue text-shadow">历史速度数据</text>
						<text class="text-ABC text-blue" style="white-space: nowrap;">历史速度数据</text>
					</view>
				</view>

				<view class="line-charts-box">
