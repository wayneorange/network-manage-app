		...
		<view class="bg-custom-container">
			<view class="charts-item">
				...
				<view class="cu-bar bg-white margin-top-xs">
					<view class="text action sub-title">
						<text class="text-xl text-bold text-blue text-shadow">磁场</text>						<text class="text-ABC text-blue" style="white-space: nowrap;">磁场</text>
					</view>
				</view>
			...
			<view class="charts-item">
				...
				<view class="cu-bar bg-white margin-top-xs">
					<view class="text action sub-title">
						<text class="text-xl text-bold text-blue text-shadow">加速度</text>						<text class="text-ABC text-blue" style="white-space: nowrap;">加速度</text>
					</view>
				</view>
				<view class="charts-box">
					<qiun-data-charts type="line" :opts="Sopts" :chartData="SchartData" />
				</view>
			</view>
			...
			<view class="charts-item">
				...
				<view class="cu-bar bg-white margin-top-xs">
					<view class="text action sub-title">
						<text class="text-xl text-bold text-blue text-shadow">陀螺仪</text>						<text class="text-ABC text-blue" style="white-space: nowrap;">陀螺仪</text>
					</view>
				</view>

				<view class="charts-box">
					<qiun-data-charts type="line" :opts="Gopts" :chartData="GchartData" />
				</view>
			</view>			
			<view class="charts-item">
				<!-- 角度 -->
				<view class="cu-bar bg-white margin-top-xs">
					<view class="text action sub-title">
						<text class="text-xl text-bold text-blue text-shadow">角度</text>						<text class="text-ABC text-blue" style="white-space: nowrap;">角度</text>
					</view>
				</view>
				<view class="charts-box">
					<qiun-data-charts type="line" :opts="Aopts" :chartData="AchartData" />
				</view>
			</view>
			...
			<view class="charts-item">
				...
				<view class="cu-bar bg-white margin-top-xs">
					<view class="text action sub-title">
						<text class="text-xl text-bold text-blue text-shadow">温度和湿度</text>						<text class="text-ABC text-blue" style="white-space: nowrap;">温度和湿度</text>
					</view>
				</view>
				<view>
