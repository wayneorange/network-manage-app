<template>
	<view>
		...
		<view class="chartsMain"><canvas canvas-id="canvasGauge" id="canvasGauge" class="charts"></canvas></view>
		<!-- 湿度 -->
		<view class="cu-bar bg-white margin-top-xs">
			<view class="action sub-title">
		...
		<view class="chartsMain"><canvas canvas-id="canvasHumidity" id="canvasHumidity" class="charts"></canvas></view>
	</view>
</template>
